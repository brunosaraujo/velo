...
export default defineConfig({
  ...
  // Tempo máximo parra assertions (toBeVisible(), toHaveText()) Por padrão sempre é 5 segundos
  // Nunca utilizar como sleep. 
  expect: {
    ...
    // Caso queira aumentar o tempo é bom colocar dentro do proprio codigo await expect(page.getByTestId('order-result-id')).toBeVisible({ timeout: 10_000 })
  },
  ...
  use: {
    ...
    // Tempo máximo para navegações como gotto(), waitForURL(), ...
